...
async function seedPlanes() {
  ...
  try {
    ...
    if (planesExistentes > 0) {
      console.log(`Ya existen ${planesExistentes} planes en la base de datos.`);
      console.log('Actualizando planes existentes y agregando nuevos...\n');
    }

    // Insertar o actualizar planes
    console.log(`Procesando ${planes.length} planes...`);
    ...
    console.log(`Total de planes procesados: ${planes.length}`);
