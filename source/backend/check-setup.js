...
try {
  require('express');
  console.log('[OK] Express instalado');
} catch (e) {
  console.log('[X] Express NO instalado - ejecuta: npm install');
  allGood = false;
}

try {
  require('@google/generative-ai');
  console.log('[OK] Google Generative AI instalado');
} catch (e) {
  console.log('[X] Google Generative AI NO instalado - ejecuta: npm install');
  allGood = false;
}

try {
  require('dotenv');
  console.log('[OK] dotenv instalado');
} catch (e) {
  console.log('[X] dotenv NO instalado - ejecuta: npm install');
  allGood = false;
}

try {
  require('jsonwebtoken');
  console.log('[OK] jsonwebtoken instalado');
} catch (e) {
  console.log('[X] jsonwebtoken NO instalado - ejecuta: npm install');
  allGood = false;
}
